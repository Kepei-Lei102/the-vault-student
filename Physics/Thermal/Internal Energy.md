...
端着一杯水走得快一点，水杯整体的动能增加了，水却不会因此自动变热。内能关心的是里面：分子怎样无规则地运动，彼此的相互作用储存着多少能量，而不是整杯水跑得多快。一杯热咖啡慢慢凉下来，是这份内部的能量在向周围转移。把“整个东西在动”和“里面的微观世界在动”分开，就抓住了“内”这个字。
...
|---|---|---|---|
| **Solid** | particles vibrate near fixed positions | set by temperature and active modes | bound interactions; zero reference must be stated |
| **Liquid** | particles remain close but rearrange | set by temperature, not automatically larger than in a solid | interaction configuration changes during melting |
| **Gas** | particles widely separated, nearly free | translational mean $\tfrac32 kT$ in the classical ideal-gas model | approximately zero in the ideal-gas model |

Heating can change random motion and the interaction configuration. During an equilibrium phase change at fixed pressure, temperature stays constant while energy is transferred. The school particle model associates the changing internal energy chiefly with intermolecular potential energy rather than an increase in mean random kinetic energy. It does not mean every intermolecular bond disappears: liquid water remains strongly interacting. Nor is all supplied heat necessarily a change in $U$; expansion can do work on the surroundings, especially in boiling. [[Specific Heat Capacity]] and [[First Law of Thermodynamics]] provide the energy accounting.

## The ideal gas — fixed amount, temperature determines internal energy
...
> **For a fixed amount and composition of ideal gas, internal energy depends on temperature alone.**
...
**Example 2 — Monatomic vs diatomic at the same temperature (equipartition enrichment).** One mole of helium and one mole of nitrogen are both at $300\,\text{K}$. Compare their internal energies.
...
The interaction configuration changes as the rigid solid structure gives way to a liquid. In the school molecular model, the increase is associated with potential energy while temperature and mean random kinetic energy stay unchanged. Melting does not remove every intermolecular interaction. After melting finishes, further transfer can raise the liquid’s temperature.
...
Not during a phase change. During an equilibrium phase change at fixed pressure, energy can change the interaction configuration while temperature stays constant. Expansion work may also take part of the supplied heat. Temperature is not a measure of the total internal-energy store.

## Exam Notes

### Cambridge 9702 — §16.1, with §15.3 and §16.2 connections

§16.1 specifies internal energy as a state-dependent sum of random molecular kinetic and potential energies, and relates temperature rise to increasing internal energy. §15.3 separately derives mean **translational** kinetic energy $\tfrac32 kT$; summing this gives $U=\tfrac32 NkT$ for a **monatomic** ideal gas. It is not a formula for every gas. §16.2 supplies the first-law accounting in [[First Law of Thermodynamics]]. State which system and which molecular model you are using; no particular question frequency or mark allocation is guaranteed.

### Cambridge 0625 — §2.1 and §2.2.2–2.2.3

The particle model, heating and internal energy, specific heat capacity and phase changes are qualitative foundations here. Supplement connects temperature rise to increasing average random kinetic energy. Monatomic-gas internal-energy equations, equipartition and statistical mechanics are enrichment; the 2026–2028 specification also does not require the quantitative latent-heat equation $Q=mL$.

### IB Physics — B.1 and B.3, both SL and HL

B.1 includes internal energy as total random kinetic plus intermolecular potential energy. **B.3 explicitly includes $U=\tfrac32 Nk_BT=\tfrac32 nRT$ for an ideal monatomic gas at both SL and HL**; it is not an HL-only result. The inspected guide does not require a diatomic equipartition derivation. B.4's further thermodynamic processes are HL; do not transfer that restriction backwards to B.3. The numbered B.1.1 etc. entries in the topic map are local grouping labels, not numbered official guide learning outcomes.

### AP Physics 2 — 9.4.A

Internal energy is the microscopic kinetic and configuration potential energy of the system. The ideal-gas model neglects intermolecular potential energy and internal structure; for a monatomic ideal gas it sums the atomic kinetic energies relative to the centre of mass. Diatomic degrees of freedom are not a stated requirement of 9.4.A. The first law and processes continue in 9.4.B; 9.3 addresses thermal transfer and equilibrium.

### Scope exclusions

The inspected current AP Physics 1 and both AP Physics C frameworks do not prescribe this thermodynamic internal-energy unit. Mechanical energy dissipation or electrical heating alone does not imply the equipartition treatment. Partition functions, quantum heat-capacity freeze-out and real-gas expansion mechanisms are enrichment for all the school courses above.
...
>
> **Real gases.** Restore the intermolecular forces and the potential term returns: $U = U(T, V)$, no longer temperature alone. An insulated free expansion into a vacuum conserves internal energy; a real gas may change temperature because $U$ can depend on volume. **Joule–Thomson throttling is a different process**, approximately constant in enthalpy for steady flow through a valve or porous plug under the usual no-work/no-heat assumptions. Whether throttling cools or warms a gas depends on the gas and its starting conditions; cooling is not universal. The ideal-gas $U = U(T)$ is the dilute limit where the wells are too far apart to matter.
>
