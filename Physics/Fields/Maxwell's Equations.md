...
你的手机收到一条消息，它来自几公里外的基站，两者之间没有电线；就算中间连空气都没有，信号照样能到。是什么把它送过来的？让基站天线里的电子上下抖动，它们周围的电场就跟着变化。变化的电场会在旁边生出磁场；这个磁场自己也在变，于是又在稍远一点的地方生出新的电场；新的电场再生出下一个磁场。每一个场都是靠另一个场的变化生出来的，所以这一对场根本不需要什么东西来托着：这个扰动自己就从天线往外走，像一排多米诺骨牌，只不过每一块倒下之后不是躺着不动，而是先把下一块立起来，再把它推倒。麦克斯韦算过这条链子应该跑多快，用的只是实验室桌面上拿线圈和电容器量出来的两个数，结果算出来的正是光速。原来光和送到你手机上的信号是同一种东西，只是抖得快得多。
