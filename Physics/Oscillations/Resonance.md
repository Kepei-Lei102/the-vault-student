...
**共振 (gòngzhèn)** = 受迫振动的振幅达到**最大**的情形；发生在**驱动频率等于固有频率**时。

生活里最好的模型是**推秋千**：你用不着使多大劲，你只是**踩着点推**——每次秋千荡到最高点将要回来的那一瞬间轻轻一推，十来下之后，秋千就荡得比你能扔出去的任何东西都高。若按你自己的节奏乱推，一半的推力会在秋千迎面而来时抵消另一半，推一下午也荡不高。秋千有自己的节奏，那就是**固有频率**；一个节奏与它相合的驱动力，**每个周期都往里存一点能量**，只存不取，积少成多。**受迫振动**的关键事实：起振的过渡过程消失后，系统以**驱动频率**（而不是固有频率）振动；振幅取决于两个频率有多接近。共振时振幅是静位移的 $Q$ 倍，峰的宽度约为 $f_0/Q$，起振要经过大约 $Q/\pi$ 个周期；而系统的振动比驱动力**滞后四分之一个周期**——这正是力与速度同相、每一次推都在做正功的条件。再想想洗衣机脱水：转速升上去的途中总有那么一阵猛抖，然后又平稳了——它**穿过**了共振点，而不是停在上面。
