...
有的考试进门就发一张公式表，有的考试只让你带一支笔进去。这个区别改变了你一整年该做什么。给公式表的考试，考的是你知道该找哪一行、知道怎么用。不给公式表的考试，tan x 的导数、旋转体的体积，都得装在脑子里，而一个只记得一半的公式比没有还糟，因为你会满怀信心地把它用错。所以，为一场不给公式表的考试准备的参考页，不是考试时拿来查的东西，而是一张考前必须背下来的清单，把该记的都收在一处，免得漏掉。用它的正确办法是：把它盖住，自己默写一遍，再掀开核对，把错的改过来，反复这样做，直到这张纸可以扔掉为止。
