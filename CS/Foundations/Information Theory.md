...
玩一局"二十个问题"：我心里想一样东西，你只能问那种我用"是"或"不是"就能回答的问题。"是大熊猫吗？"是个糟糕的问题，因为我几乎肯定会说"不是"，你几乎什么也问不出来。"它是活的吗？"就是个好问题，因为不管我怎么回答，可能性都差不多被砍掉一半。每这样砍一半，就是一比特的信息；二十个好问题，足够从一百万样东西里挑出唯一的一样，因为把一百万对半砍二十次，正好剩下一个。信息论的全部想法就在这里：信息就是能减少你的不确定的东西，它的多少，就是它替你省下了几个"是不是"的问题。所以"今天早上太阳从东边升起"不带任何信息，因为你本来就确定；而"成都七月下雪了"信息量极大：一件事越罕见，发生时你越吃惊，你从中知道的也就越多。1948 年香农把这个想法写成了公式，它能提前告诉你，一个文件最多能压缩到多小，一条有噪声的电话线最多能传多少东西；这些上限，在任何人动手设计压缩软件或电话系统之前就能算出来。

### 术语对照 (Terms)

**信息论 (xìnxī lùn)**：中心公式 $I(p) = -\log_2 p$ 比特；$p = 1$ 时 $I = 0$。
