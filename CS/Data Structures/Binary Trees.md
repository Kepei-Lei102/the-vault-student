...
玩猜数字时，你问“是五十吗”，朋友说“更小”，下一次就不用再猜八十了。把接下来该问哪个数也画出来，每次分成“更小”和“更大”两条路，就得到了一棵用来查找的二叉树。沿着一条路走，就能排除另一边的一整片可能。二叉树本身只规定每个位置最多分出两条路；要拿它查数，还得守住左边全小、右边全大的规矩。至于一次能排除多少，要看两边长得匀不匀，并不是只要分成两条路，就能自动排除掉一半候选。
