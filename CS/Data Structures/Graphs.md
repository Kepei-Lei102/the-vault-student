...
看一张地铁线路图。隧道明明是弯的，图上的线却画得笔直；有的两站之间要开五分钟，有的只要一分钟，图上却画得一样远；图上甚至可能根本没画出那条江。真实城市里的东西几乎全被扔掉了，可你照样能靠它把整趟行程安排好，因为“从这儿怎么到那儿”这个问题只取决于一件事：哪一站和哪一站连着。只留下东西和东西之间的连接，其余全部丢掉，剩下的就是图。所以同一个想法既能用在微信好友上，也能用在导航软件里的道路上，还能用在互相链接的网页上：只要都化成了点和连着点的线，“我怎么通过朋友的朋友联系到一个陌生人”和“我怎么穿过半个城市”就是同一个问题，一种方法两边都能解。
