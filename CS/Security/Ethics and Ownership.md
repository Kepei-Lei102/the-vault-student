...
2020 年那篇刷屏的文章《外卖骑手，困在系统里》讲的就是这张卡：算法把送餐时限一压再压，骑手闯红灯、逆行，出事的是人，"决定"的是代码——可代码不会负责，写代码的人才会。这就是**职业伦理**的全部意思：你做的系统会落在看不见它、也改不了它的人身上，法律通常要好几年才追上来，公司的利益往往指向另一边，**唯一一道能提前挡住的关口，是写它的人**。所以有 BCS、IEEE 这样的**专业组织**把规矩写成**行为准则**：对公众（安全、隐私、不歧视），对雇主（尽责、不利益冲突），对同事（署名、公平、接受批评），对行业本身。**所有权**是硬币的另一面：你写的程序一落笔就有**版权**，别人怎么用取决于你附上的**许可证**——从"随便用，留个署名"的宽松许可，到"改了必须开源"的 GPL，到"试用满意再付费"的共享软件，到"花钱买、看不到源码"的商业软件；记住"免费软件（freeware）"不等于"自由软件（free software）"，一个说的是价格，一个说的是自由。最后是 **AI**：模型从历史数据里学，就把历史里的偏见一起学走——删掉"性别"那一列没用，它会从邮编里把性别读回来（这张卡的程序就真这么干了）；模型用别人的作品训练，产出的东西归谁，法律还在吵。你自己也在这张卡里：**把 AI 写的作业当成自己的交上去，就是把"能验证"这项本事让给了机器**——[[Learning as Verification]] 讲的正是这个。
