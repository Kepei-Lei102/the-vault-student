...
你每天都会收到好几条这样的短信："验证码 483920，5 分钟内有效，请勿泄露给任何人。"登录微信、用支付宝付款、在 12306 买票，都要来一次。为什么有了密码还不够？因为密码只是"你知道的东西"，而知道的东西可以被猜到，可以从另一个你用了同样密码的网站上被偷走，也可以被人骗走。验证码证明的是另一件不同的事：此刻这部手机就在你手里。远在地球另一边的小偷也许拿到了你的密码，却拿不到你的手机，所以两把不同种类的弱锁合在一起，就成了一扇结实的门。再看短信的后半句："请勿泄露给任何人。"之所以要写这句话，是因为绕过这两把锁最省事的办法，根本不是去撬锁，而是打一个电话，冒充银行，让你自己把验证码念出来。攻击者下手，专挑最薄弱的地方，而最薄弱的地方往往是人。所以保护数据靠的是一层一层地设防，让闯过一层的人撞上另一道不同种类的防线，而这些防线里，有一层必须是你自己。
